package com.bingo.base.ui.views.recyclerview;
...
public class RecyclerViewUtils {
    ...
    public static void setHeaderView(RecyclerView recyclerView, View view) {
        ...
        if (outerAdapter == null || !(outerAdapter instanceof HeaderFooterAdapterWrapper)) {
            return;
        }

        HeaderFooterAdapterWrapper headerAndFooterAdapter = (HeaderFooterAdapterWrapper) outerAdapter;
    ...
    public static void removeFooterView(RecyclerView recyclerView) {
        ...
        if (outerAdapter != null && outerAdapter instanceof HeaderFooterAdapterWrapper) {
            ...
            int footerViewCounter = ((HeaderFooterAdapterWrapper) outerAdapter).getFooterViewsCount();
            if (footerViewCounter > 0) {
                View footerView = ((HeaderFooterAdapterWrapper) outerAdapter).getFooterView();
                ((HeaderFooterAdapterWrapper) outerAdapter).removeFooterView(footerView);
            }
        }
    }
    ...
    public static void removeHeaderView(RecyclerView recyclerView) {
        ...
        if (outerAdapter != null && outerAdapter instanceof HeaderFooterAdapterWrapper) {
            ...
            int headerViewCounter = ((HeaderFooterAdapterWrapper) outerAdapter).getHeaderViewsCount();
            if (headerViewCounter > 0) {
                View headerView = ((HeaderFooterAdapterWrapper) outerAdapter).getHeaderView();
                ((HeaderFooterAdapterWrapper) outerAdapter).removeFooterView(headerView);
            }
        }
    }
